...
class M_manufacture extends CI_Model {    
   ...
   function list_manufacture() {
        $query = $this->db->query("SELECT tb_manufacture.id_manufacture,tb_manufacture.nama_manufacture,tb_manufacture.tel_manufacture,tb_manufacture.tipe FROM tb_manufacture
            ORDER BY tb_manufacture.id_manufacture DESC");
        return $query;
    } 
    function list_manufactureid() {
        $gid=$this->session->userdata('gid');
        $query = $this->db->query("SELECT tb_manufacture.nama_manufacture,tb_manufacture.tel_manufacture,tb_manufacture.tipe FROM tb_manufacture 
            ORDER BY tb_manufacture.id_manufacture DESC");
        return $query;
    }
