...
<table width="728" height="384" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="6"  id="noBorder"><strong><u>MUTASI INVENTORY BARANG </u></strong></td>
  </tr>
  <tr>
    <td colspan="6" id="noBorder2"><div align="center"><u><strong>ICT NEtWare</strong></u></div></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td id="noBorder">:</td>
    <td id="noBorder"><div align="left">Komputer</div></td>
    <td colspan="3" id="noBorder">&nbsp;</td>
   </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="726" height="82" >
      ...
      <?php 
		...
		$pengguna_awal = $this->db->query("SELECT tb_pengguna.id_pengguna,tb_pengguna.nama_pengguna,tb_departemen.nama,tb_departemen.parent 
					FROM tb_pengguna INNER JOIN tb_departemen ON tb_departemen.id_dept = tb_pengguna.id_dept 
